...
const About: React.FC<AboutProps> = ({ 
  language, 
  estDate = "23/04/2015", 
  location = "Near Gokarneshwor Banquet, Kathmandu" 
}) => {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
          <div className="space-y-8">
             ...
             <p className="text-xl text-slate-600 leading-relaxed font-light">
               {language === 'en' 
                 ? `Utsaha Jagrity Mandali is a vibrant Christian fellowship located ${location}. Our ministry is dedicated to the exaltation of God through worship, the edification of saints through discipleship, and the evangelization of the world through the Gospel of Jesus Christ.` 
